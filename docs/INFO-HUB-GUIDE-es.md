...
| **Table booking** | Mostrar botón de reserva de mesa (si maca Menulist está disponible) |
...
- **Reserva de mesa** — los eventos pueden mostrar un botón de reserva si maca Menulist está instalado
